...
# 根目录
root_dir = "mmPencil_dataset/mmWave_Trajectory"

# 输出目录
output_json_200 = "trajectory-based_recognition/dataset_index/200-Word.json"
output_json_zero = "trajectory-based_recognition/dataset_index/zero-shot.json"
output_json_user = "trajectory-based_recognition/dataset_index/user-split.json"
...
# 文件名解析
pattern = re.compile(r'(?P<experiment>[^_]+)_(?P<subject>[^_]+)_(?P<word>[^_]+)_(?P<trial>w\d+)\.png')
